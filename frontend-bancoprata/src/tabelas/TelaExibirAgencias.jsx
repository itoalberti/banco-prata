...
export default function TelaExibirAgencias(props) {
  ...
  function excluirAgencia(props) {
    fetch(urlAgencia, {
      ...
      .then((resp) => {
        console.log(resp);
        setListaAgencias(listaAgencias.filter((agencia) => agencia.cod_ag !== props.cod_ag));
        alert(resp.msg);
      });
  }
                  ...
                  <td style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <div>
                      <Button
                        ...
                        onClick={() => {
                          if (window.confirm('Deseja excluir a agência ' + agencia.cod_ag + '?')) excluirAgencia(agencia);
                        }}
                      >
